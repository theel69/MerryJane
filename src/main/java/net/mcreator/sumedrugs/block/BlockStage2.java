...
public class BlockStage2 extends ElementsSUMEDrugs.ModElement {
	@GameRegistry.ObjectHolder("sumedrugs:stage2")
	public static final Block block = null;
	public BlockStage2(ElementsSUMEDrugs instance) {
		super(instance, 9);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "sumedrugs:tileentitystage2");
	}
	...
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			return new AxisAlignedBB(0.17D, 0D, 0.17D, 0.83D, 0.95D, 0.83D);
		}
