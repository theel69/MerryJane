...
public class ProcedureJointRightClickedInAir extends ElementsSUMEDrugs.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		world.playSound((EntityPlayer) null, (entity.posX), (y + 1.5), (entity.posZ),
				(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("sumedrugs:blunt")),
				SoundCategory.NEUTRAL, (float) 1, (float) 1);
		for (int index0 = 0; index0 < (int) (5); index0++) {
			if (world instanceof WorldServer)
				((WorldServer) world).spawnParticle(EnumParticleTypes.SPIT, (entity.posX), (y + 1.5), (entity.posZ), (int) 1, 0, 0, 0, 0.1,
						new int[0]);
		}
	}
}
